...
public class PC { // персональный компьютер
    ...
    public void addvol(double v){                                                   // перегруженный метод
        System.out.println("Поступил заказ на процессор с " + v + " мощностью");
    }
    ...
    public void type(String ... x){                                                 // изменяемое число входных параметров и перегруженный
        System.out.println("Запрос на производство видов ПК и доп. атрибутики");
