public class SearchSystem { // поисковая система
    ...
    public void qu(String s){                                                           // перегруженный метод
        System.out.print("Самый популярный запрос на этой неделе: " + s);
    }
    ...
    public void countr(String ... s){                                                               // изменяемое число входных данных
        System.out.println("Сервера распологаются в след. странах: ");
