...
public class Confectionery {      // кондитерские изделия
    ...
    public void prod(int n){                                                            // перегруженный метод
        System.out.println(n + " пачек печенья, конфет и вафель были переданы детским домам");
        cookie -= n;
        candy -= n;
        wafers -= n;
    }
    ...
    public void coop(String ... s){                                                                         // изменяемое число входных параметров
        System.out.println("Фабрика сотрудничает со следующими брендами: ");
