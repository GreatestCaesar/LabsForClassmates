...
public class MilkProducts { // молочная продукция
    ...
    public void tare(String ... s){                                                                      // изменяемое число входных параметров
        System.out.println("Заказ на поставку молока в следующих упаковках: ");
        for (int i=0;i<s.length;i++){
            System.out.println(s[i]);
        }
    }

    public void prod(String ... s){                                                                      // перегруженный метод с изменяемыми входными данными
        System.out.println("Контракт в магазины \"Евроопт\" включает следующую продукцию");
        for(int i=0;i<s.length;i++){
            System.out.println(s[i]);
        }
    }
