...
public class TireFactory { // завод шин
    ...
    public double profit(double tax){ // чистая прибыл                         -------- перегруженный метод
        return (count*cost)-(count*cost*tax/100);
    }
    ...
    public void coop(String ... n){ // сотрудничество                           ------ изменяемое число входных параметров
        System.out.println("Завод сотрудничает с: ");
    ...
    public void size(int... c){
        System.out.println("Размеры выпускаемой резины");
