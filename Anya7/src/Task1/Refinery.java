...
public class Refinery { // завод нефтепродуктов
    ...
    public void transp(String ... n){ // транспортировка
        System.out.println("Транспортируется следующим транспортом: ");
    ...
    public void profit(int ... x){                                                        // с изменяемым числом входных параметров и перегруженный
        System.out.println("Прибыль за 2 квартала: ");
