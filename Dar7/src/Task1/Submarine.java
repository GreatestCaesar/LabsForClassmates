...
public class Submarine { //подлодка
    ...
    public void inc(int n, String s){                                                       // перегруженный метод
        System.out.println("Установить в подлодку " + n + " единиц \'" + s + "\'");
    }
    ...
    public void com(String ... s){                                                          // изменяемое число входных параметров
        System.out.print("Представить к награде следующих членов экипажа: ");
        for(int i=0;i<s.length;i++){
            System.out.print(s[i] + " ");
        }
        System.out.println(" за доблестную службу");
    }
