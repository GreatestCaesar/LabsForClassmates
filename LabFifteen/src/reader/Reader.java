...
public class Reader extends Book implements exc, take{
    ...
    public void pag(int n) throws MyException{
        if(super.getPage()<(page+n)){
            throw new MyException((page+n)-super.getPage());
        }else {
            System.out.println("Прочитал за сегодня странц: " + n);
            page += n;
        }
    }
