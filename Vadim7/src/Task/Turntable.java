...
public class Turntable { // винил
    ...
    public void speen(int ... n){   // перегруженный метод с изменяемым числом входным данных
        System.out.println("Новый двигатель для прокрутки винила позволяет достигать следующих оборотов: ");
        for(int i=0;i< n.length;i++){
            System.out.println(n[i] + " об/мин");
        }
    }
